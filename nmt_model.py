...
class NMT(nn.Module):
    ...
    def encode(self, source_padded: torch.Tensor, source_lengths: List[int]) -> Tuple[
        ...
        # print('START')
        batch_size = source_padded.shape[1]
        ...
        h_0 = torch.cat((h_0[0], h_0[1]), 1)
        init_decoder_hidden = self.h_projection(h_0)

        # concatenate c_0 to shape [b, 2 *h] and apply it to c_projection liner layer
        c_0 = torch.cat((c_0[0], c_0[1]), 1)
        init_decoder_cell = self.c_projection(c_0)
    ...
    def step(self, Ybar_t: torch.Tensor,
        ...
        # print('an example of alpha_t tensor = {}'.format(alpha_t[0]))
